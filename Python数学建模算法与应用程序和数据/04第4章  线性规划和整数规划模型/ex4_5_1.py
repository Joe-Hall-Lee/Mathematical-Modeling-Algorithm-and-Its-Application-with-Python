...
import cvxpy as cp
import pandas as pd
c = np.genfromtxt("data4_5_1.txt", dtype=float, max_rows=6,
                  usecols=range(8))  # 读前 6 行前 8 列数据
e = np.genfromtxt("data4_5_1.txt", dtype=float,
                  max_rows=6, usecols=8)  # 读最后一列数据
