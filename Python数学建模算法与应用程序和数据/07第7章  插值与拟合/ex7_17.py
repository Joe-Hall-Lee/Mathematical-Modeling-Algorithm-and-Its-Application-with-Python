...
x0 = np.array([0.81, 0.91, 0.13, 0.91, 0.63, 0.098,
              0.28, 0.55, 0.96, 0.96, 0.16, 0.97, 0.96])
y0 = np.array([0.17, 0.12, 0.16, 0.0035, 0.37, 0.082, 0.34,
              0.56, 0.15, -0.046, 0.17, -0.091, -0.071])


def y(x, a, b, c, d, k): return (a+b*x)*(x < k)+(c+d*x)*(x >= k)
