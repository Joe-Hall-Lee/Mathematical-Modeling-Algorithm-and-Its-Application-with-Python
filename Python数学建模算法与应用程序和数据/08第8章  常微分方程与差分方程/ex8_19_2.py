...
# 决策向量 z 的排序为 x1, x2, x3, x4, k
def n(z): return m/2*(1-a-0.42*z[4])**8*z[2]+m*(1-a-z[4])**8*z[3]


def b(z): return 1.22*10**11/(1.22*10**11+n(z))


def obj(z): return -(0.42*z[4]*w[2]*(1-(1-a-0.42*z[4])**8)/(a+0.42*z[4])*z[2] +
